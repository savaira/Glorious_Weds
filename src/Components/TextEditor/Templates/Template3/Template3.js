...
const Template3 = (props) => {
    ...
    const setdata = () =>{
       ...
       textAlignment:"none",
        ...
        setfield10({...field10,
          ...
          textAlignment:"none",
            data:"In the name of Allah, the Most Beneficent, the Most Merciful"})
        setCardColor({...cardColor , bgColor:"navy"});
      }
    useEffect(async() => {
        setdata();
      },[props.name]);
   ...
   <option value="24px">24</option>  
    ...
    <div id="ab" style={{height:"600px",width:"500px",marginTop:"8%"}} >
            <Container className="design3" style={{backgroundColor:cardColor.bgColor}}>
                <Row>
                    <Col>
                    ...
                    <Col>
                    <Draggable>
            <textarea id="f10" className="bless"
          ...
          <input id="f1" size="25" className="fatherName3" value={field1.data} onChange={e => setfield1({...field1 ,data : e.target.value})} onClick={() => selected(1)} style={{fontFamily:field1.style,fontSize:field1.size,fontStyle:field1.italics,fontWeight:field1.bold,color:field1.color,backgroundColor:field1.bgColor,textAlign:field1.textAlignment,width:"300px",height:"40px"}}/>
            ...
            <Row>
                <Col>
                <Draggable>
            <textarea id="f2" className="inviteArea3"
            value={field2.data} onChange={e => setfield2({...field2 ,data : e.target.value})}  onClick={() => selected(2)} style={{fontFamily:field2.style,fontSize:field2.size,fontStyle:field2.italics,fontWeight:field2.bold,color:field2.color,backgroundColor:field2.bgColor,textAlign:field2.textAlignment,width:"460px",height:"70px"}}
            rows="2" cols="47"/>
            </Draggable>
          </Col>
            </Row>
