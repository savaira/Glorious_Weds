...
const Template2 = (props) => {
   ...
   <option value="24px">24</option>  
    ...
    <div id="ab" style={{height:"600px",width:"500px",marginTop:"5%"}} >
            <Container className="design2" style={{backgroundColor:cardColor.bgColor}}>
                <Row>
                    <Col >
          ...
          <Row>
                <Col>
                <Draggable>
            <textarea id="f2" className="inviteArea2"
           value={field2.data} onChange={e => setfield2({...field2 ,data : e.target.value})}  onClick={() => selected(2)} style={{fontFamily:field2.style,fontSize:field2.size,fontStyle:field2.italics,fontWeight:field2.bold,color:field2.color,backgroundColor:field2.bgColor,textAlign:field2.textAlignment,width:"400px",height:"70px"}}
            rows="2" cols="47"/>
             </Draggable>
          </Col>
            </Row>
