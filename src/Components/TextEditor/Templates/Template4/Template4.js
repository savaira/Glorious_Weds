...
const handleClick = () => {
  ...
  const cover2 = {
    ...
    (props.name.location && props.name.location.field) || {};
      const [cardColor,setCardColor]=useState({
       ...
       const[select,setselect]=useState('');
         ...
         const[field2,setfield2]=useState({
             ...
             bgColor:"purple",
             textAlignment:"center",
             data:"Requests the honour of your presence at the Wedding Ceremony of his beloved son"
         });
     ...
     const[field10,setfield10]=useState({
      ...
      bgColor:"purple",
    textAlignment:"none",
      data:`"In the name of Allah, the Most Beneficent, the Most Merciful"`
    });
    ...
    textAlignment:"none",
      ...
      const setdata = () =>{
       ...
       textAlignment:"none",
        ...
        setCardColor({...cardColor , bgColor:"purple"});
      }
    useEffect(async() => {
        setdata();
      },[props.name]);
  ...
  setfield11({...field11 ,size : e.target.value})
}
             else {
  ...
  setfield11({...field11 ,textAlignment : e.target.value})
         ...
         const reset=()=>{
            ...
            var x10 = document.getElementById("f10");
            var x11 = document.getElementById("f11");
            var x12 = document.getElementById("f12");
            ...
            if (window.getComputedStyle(x10).visibility === "hidden") {
                                    x10.style.visibility = "visible";
                                    }
             if (window.getComputedStyle(x11).visibility === "hidden") {
                                        x11.style.visibility = "visible";
                                        }
            if (window.getComputedStyle(x12).visibility === "hidden") {
                                            x12.style.visibility = "visible";
                                            }
                }
                const deleteField = () => {
                    if (select == 1) {
   ...
   <option value="24px">24</option>  
    ...
    <div id="ab" style={{height:"600px",width:"500px",marginTop:"8%"}} >
            <Container className="designCard4" style={{backgroundColor:cardColor.bgColor,borderLeftWidth:'120px'}}>
                <Row>
                    <Col>
                    <Draggable>
                    <textarea id="f10" className="bless4"
             value={field10.data} onChange={e => setfield10({...field10 ,data : e.target.value})} onClick={() => selected(10)} style={{fontFamily:field10.style,fontSize:field10.size,fontStyle:field10.italics,fontWeight:field10.bold,color:field10.color,backgroundColor:field10.bgColor,textAlign:field10.textAlignment,width:"550px",height:"40px"}}
            rows="1" cols="50"/>
            </Draggable>
                    </Col></Row>
                    <Row>
          ...
          <input id="f1" size="25" className="fatherName4" value={field1.data} onChange={e => setfield1({...field1 ,data : e.target.value})} onClick={() => selected(1)} style={{fontFamily:field1.style,fontSize:field1.size,fontStyle:field1.italics,fontWeight:field1.bold,color:field1.color,backgroundColor:field1.bgColor,textAlign:field1.textAlignment,width:"300px",height:"40px"}}/>
            ...
            <Row>
                <Col>
                <Draggable>
            <textarea id="f2" className="inviteArea4"
           value={field2.data} onChange={e => setfield2({...field2 ,data : e.target.value})}  onClick={() => selected(2)} style={{fontFamily:field2.style,fontSize:field2.size,fontStyle:field2.italics,fontWeight:field2.bold,color:field2.color,backgroundColor:field2.bgColor,textAlign:field2.textAlignment,width:"460px",height:"50px"}}
            rows="2" cols="47"/>
            </Draggable>
          </Col>
            </Row>
