...
const Template1 = (props) => {
  ...
  // const setdata = () =>{
  //     setfield1({...field1 ,data :bfname})
  //     setfield3({...field3 ,data :bname})
  //     setfield5({...field5 ,data :gname})
  //     setfield6({...field6 ,data :ftype})
  //     setfield7({...field7 ,data :fdate})
  //     setfield8({...field8 ,data :dtime})
  //     setfield9({...field9 ,data :venue})
  //   }
  const setdata = () => {
    setfield1({
      ...field1,
    ...
    setCardColor({ ...cardColor, bgColor: "maroon" });
  };
  useEffect(async () => {
    setdata();
  }, [props.name]);
  const selected = (a) => {
    ...
    if (a == 1) {
      setfield({
        ...
        color: field1.color,
        size: field1.size,
        textAlignment: field1.textAlignment,
        marginLeft: field1.marginLeft,
        marginTop: field1.marginTop,
      });
    } else if (a == 2) {
      setfield({
        ...field,
        ...
        color: field2.color,
        size: field2.size,
        textAlignment: field2.textAlignment,
      });
    } else if (a == 3) {
      setfield({
        ...field,
        ...
        color: field3.color,
        size: field3.size,
        textAlignment: field3.textAlignment,
      });
    } else if (a == 4) {
      setfield({
        ...field,
        ...
        color: field4.color,
        size: field4.size,
        textAlignment: field4.textAlignment,
      });
    } else if (a == 5) {
      setfield({
        ...field,
        ...
        color: field5.color,
        size: field5.size,
        textAlignment: field5.textAlignment,
      });
    } else if (a == 6) {
      setfield({
        ...field,
        ...
        color: field6.color,
        size: field6.size,
        textAlignment: field6.textAlignment,
      });
    } else if (a == 7) {
      setfield({
        ...field,
        ...
        color: field7.color,
        size: field7.size,
        textAlignment: field7.textAlignment,
      });
    } else if (a == 8) {
      setfield({
        ...field,
        ...
        color: field8.color,
        size: field8.size,
        textAlignment: field8.textAlignment,
      });
    } else {
      setfield({
        ...field,
        ...
        color: field9.color,
        size: field9.size,
        textAlignment: field9.textAlignment,
      });
    }
  };
  ...
  return (
    <div>
      <Container className="toolbar1">
        <Row>
          ...
          <Col className="toolItems">
            ...
            <Button className={ac.root} onClick={handleClick}>
              Select
            </Button>
          ...
          <Col sm={2} className="toolItems">
            <h5 className="btName" sm={9}>
              Card Color
            </h5>
            <Button className={ac.root} onClick={handleClick2}>
              Pick Color
            </Button>
            {display2.displayColorPicker2 ? (
              <div style={popover2}>
          ...
          <Col className="toolItemsButton1">
            ...
            <Button className={ab.root} onClick={BoldButton}>
              B
            </Button>
          </Col>
          <Col className="toolItemsButton1">
            <h5 className="btName">Italics</h5>
            <Button className={ab.root} onClick={ItalicButton}>
              I
            </Button>
          </Col>
        </Row>
      ...
      <div style={{ marginLeft: "25%" }}>
        <div
          id="ab"
          style={{ height: "600px", width: "500px", marginTop: "7%" }}
        >
          <Container
            className="design1"
       ...
       <form id="myForm"></form>
                ...
                <Draggable>
                  <input
                    ...
                    value={field1.data}
                    onChange={(e) =>
                      setfield1({ ...field1, data: e.target.value })
                    }
                    onClick={() => selected(1)}
                    style={{
                      fontFamily: field1.style,
                      fontSize: field1.size,
                      fontStyle: field1.italics,
                      fontWeight: field1.bold,
                      color: field1.color,
                      backgroundColor: field1.bgColor,
                      textAlign: field1.textAlignment,
                      width: "350px",
                      height: "40px",
                    }}
                  />
            ...
            <Row>
              <Col>
                <Draggable position={field2.position}>
                  <textarea
                    id="f2"
                    className="inviteArea"
                    value={field2.data}
                    onChange={(e) =>
                      setfield2({ ...field2, data: e.target.value })
                    }
                    onClick={() => selected(2)}
                    style={{
                      fontFamily: field2.style,
                      fontSize: field2.size,
                      fontStyle: field2.italics,
                      fontWeight: field2.bold,
                      color: field2.color,
                      backgroundColor: field2.bgColor,
                      textAlign: field2.textAlignment,
                      width: "400px",
                      height: "60px",
                    }}
                    rows="2"
              ...
              <Col>
                <Draggable>
                  <input
                    ...
                    value={field3.data}
                    onChange={(e) =>
                      setfield3({ ...field3, data: e.target.value })
                    }
                    onClick={() => selected(3)}
                    style={{
                      fontFamily: field3.style,
                      fontSize: field3.size,
                      fontStyle: field3.italics,
                      fontWeight: field3.bold,
                      color: field3.color,
                      backgroundColor: field3.bgColor,
                      textAlign: field3.textAlignment,
                      width: "300px",
                      height: "40px",
                    }}
                  />
              ...
              <Col>
                <Draggable>
                  <input
                    ...
                    value={field4.data}
                    onChange={(e) =>
                      setfield4({ ...field4, data: e.target.value })
                    }
                    onClick={() => selected(4)}
                    style={{
                      fontFamily: field4.style,
                      fontSize: field4.size,
                      fontStyle: field4.italics,
                      fontWeight: field4.bold,
                      color: field4.color,
                      backgroundColor: field4.bgColor,
                      textAlign: field4.textAlignment,
                      width: "200px",
                      height: "30px",
                    }}
                  />
              ...
              <Col>
                <Draggable>
                  <input
                    ...
                    value={field5.data}
                    onChange={(e) =>
                      setfield5({ ...field5, data: e.target.value })
                    }
                    onClick={() => selected(5)}
                    style={{
                      fontFamily: field5.style,
                      fontSize: field5.size,
                      fontStyle: field5.italics,
                      fontWeight: field5.bold,
                      color: field5.color,
                      backgroundColor: field5.bgColor,
                      textAlign: field5.textAlignment,
                      width: "300px",
                      height: "40px",
                    }}
                  />
              ...
              <Col>
                <Draggable>
                  <input
                    ...
                    value={field6.data}
                    onChange={(e) =>
                      setfield6({ ...field6, data: e.target.value })
                    }
                    onClick={() => selected(6)}
                    style={{
                      fontFamily: field6.style,
                      fontSize: field6.size,
                      fontStyle: field6.italics,
                      fontWeight: field6.bold,
                      color: field6.color,
                      backgroundColor: field6.bgColor,
                      textAlign: field6.textAlignment,
                      width: "300px",
                      height: "30px",
                    }}
                  />
              ...
              <Col>
                <Draggable>
                  <input
                    ...
                    value={field7.data}
                    onChange={(e) =>
                      setfield7({ ...field7, data: e.target.value })
                    }
                    onClick={() => selected(7)}
                    style={{
                      fontFamily: field7.style,
                      fontSize: field7.size,
                      fontStyle: field7.italics,
                      fontWeight: field7.bold,
                      color: field7.color,
                      backgroundColor: field7.bgColor,
                      textAlign: field7.textAlignment,
                      width: "300px",
                      height: "30px",
                    }}
                  />
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setfield8({
                        ...field8,
                        data: e.target.value,
                        textAlign: field8.textAlignment,
                      })
                    }
                    onClick={() => selected(8)}
                    style={{
                      fontFamily: field8.style,
                      fontSize: field8.size,
                      fontStyle: field8.italics,
                      fontWeight: field8.bold,
                      color: field8.color,
                      backgroundColor: field8.bgColor,
                      width: "300px",
                      height: "30px",
                    }}
                  />
            ...
            <Row>
              <Col>
                <Draggable>
                  <textarea
                    id="f9"
                    className="funVenueName"
                    rows="2"
                    cols="30"
                    value={field9.data}
                    onChange={(e) =>
                      setfield9({ ...field9, data: e.target.value })
                    }
                    onClick={() => selected(9)}
                    style={{
                      fontFamily: field9.style,
                      fontSize: field9.size,
                      fontStyle: field9.italics,
                      fontWeight: field9.bold,
                      color: field9.color,
                      backgroundColor: field9.bgColor,
                      textAlign: field9.textAlignment,
                      width: "300px",
                      height: "30px",
                    }}
                  />
